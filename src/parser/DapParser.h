...
public:
  ...
  enum {
    ...
    RuleDelete_stmt = 4, RuleDo_stmt = 5, RuleExpression = 6, RuleExpressionList = 7, 
    RuleOf_var_list = 8, RuleIdentifiers_list = 9, RuleIn_var_list = 10, 
    RuleColonInts = 11, RuleLiteral = 12, RuleVariables = 13, RuleAbort_main = 14, 
    RuleAbort_stmt = 15, RuleFile_spec = 16, RuleProc_main = 17, RuleProc_stmt = 18, 
    RuleProc_name = 19, RuleArray_main = 20, RuleArray_stmt = 21, RuleArray_name = 22, 
    RuleArray_subscript = 23, RuleArray_elements = 24, RuleInitial_value_list = 25, 
    RuleInitial_value_list_item = 26, RuleInitial_value_list_bk = 27, RuleConstant_iter_value = 28, 
    RuleConstant_value = 29, RuleAssign_main = 30, RuleAssign_stmt = 31, 
    RuleBy_main = 32, RuleBy_stmt = 33, RuleCall_main = 34, RuleCall_stmt = 35, 
    RuleData_main = 36, RuleData_stmt = 37, RuleDataset_name_opt = 38, RuleDatastmt_cmd = 39, 
    RuleView_dsname_opt = 40, RuleView_name = 41, RuleDataset_name = 42, 
    RuleProgram_name = 43, RulePasswd_opt = 44, RuleSource_opt = 45, RuleDatalines_main = 46, 
    RuleDatalines_stmt = 47, RuleDatalines4_stmt = 48, RuleDrop_main = 49, 
    RuleDrop_stmt = 50, RuleInfile_main = 51, RuleInfile_stmt = 52, RuleFile_specification = 53, 
    RuleDevice_type = 54, RuleInfile_options = 55, RuleInput_main = 56, 
    RuleInput_stmt = 57, RulePut_stmt = 58, RuleInput_specification = 59, 
    RulePut_specification = 60, RulePointer_control = 61, RuleInformat_list = 62, 
    RuleInput_variable_format = 63, RuleInput_variable = 64, RulePut_variable_format = 65, 
    RulePut_variable = 66, RuleColumn_point_control = 67, RuleLine_point_control = 68, 
    RuleFormat_modifier = 69, RuleColumn_specifications = 70, RuleMeans_main = 71, 
    RuleMeans_proc = 72, RuleRun_main = 73, RuleRun_stmt = 74
  };

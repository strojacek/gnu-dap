...
The preprocessor, which is named dappp, reads \Texinfocommandstyletextvar{file}.cpp,
performs the following four actions to create \Texinfocommandstyletextvar{file}.dap.cpp:  
...
so that line numbers in C++ compiler messages for \Texinfocommandstyletextvar{file}.dap.cpp correspond
exactly to line numbers in \Texinfocommandstyletextvar{file}.cpp.  
